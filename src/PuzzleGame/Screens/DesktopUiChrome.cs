...
internal static class DesktopUiChrome
{
    public static float GetViewportScale(Viewport viewport)
    {
        ...
        return MathHelper.Clamp(MathF.Min(widthScale, heightScale), min: 0.62f, max: 1.3f);
    }
        ...
        Color accent)
    {
        ...
        spriteBatch.Draw(
            ...
            sheenBounds,
            Color.White * (0.08f * clampedAlpha));
